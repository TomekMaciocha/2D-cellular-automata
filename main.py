...
def main() -> None:
    ...
    while True:
        ...
        while True:
            ...
            another_ani = input('Do you want to make another animation of this simulation? (\'Y\' or \'y\' count as yes; any other as no):')
        ...
        another_sim = input('Do you want to run another simulation? (\'Y\' or \'y\' count as yes; any other as no):')
